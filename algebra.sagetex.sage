...
_st_.blockend()
try:
 _st_.current_tex_line = 948
 _st_.inline(20, latex(a^(-1)))
except:
 _st_.goboom(948)
_st_.current_tex_line = 950
_st_.blockbegin()
try:
 b=mod(7,17)
 a*b
