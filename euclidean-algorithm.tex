...
\begin{proposition}
The greatest common divisor of two integers is the smallest positive integer that can be written as a linear combination of the two integers, with integer coefficients.
\end{proposition}
\begin{proof}
