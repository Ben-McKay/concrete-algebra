...
If \(k \subset K\) is a subfield, a \emph{spanning set}\define{spanning set} of \(K\) over \(k\) is a collection of elements \(\alpha_1, \alpha_2, \dots, \alpha_n\) of \(K\) so that every element of \(K\) has the form
\[
