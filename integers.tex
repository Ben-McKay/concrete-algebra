...
Given any collection of one or more integers, not all zero, prove that they have a unique \emph{greatest common divisor}\define{greatest common divisor}, i.e. a common divisor \(d\ge 0\) so that every common divisor divides \(d\). 
\end{problem}
